...
여기서 중요한 건 이 1,800만원이 **계좌마다가 아니라 사람마다** 붙는다는 점입니다. 연금저축계좌 여러 개와 IRP, 그리고 퇴직연금 DC형(Defined Contribution, 확정기여형)에 본인이 추가로 넣는 돈까지 <mark>전부 합쳐서 연 1,800만원</mark>이에요. 증권사를 나눠 계좌를 늘려도 한도는 늘지 않습니다.

세액공제 한도 쪽은 한 겹이 더 있습니다. 같은 조문을 그대로 옮기면 이렇습니다.

"연금저축계좌에 납입한 금액이 연 600만원을 초과하는 경우에는 그 초과하는 금액은 없는 것으로 하고, 연금저축계좌에 납입한 금액 중 600만원 이내의 금액과 퇴직연금계좌에 납입한 금액을 합한 금액이 연 900만원을 초과하는 경우에는 그 초과하는 금액은 없는 것으로 한다." — 「소득세법」 제59조의3 제1항
...
숫자의 크기 차이를 그림으로 보면 이렇습니다. 마지막 막대는 제도가 정한 한도가 아니라, 실제로 사람들이 한 해에 넣는 평균 금액이에요.

![한도는 1,800만원인데 실제 평균 납입액은 161만원 — 납입한도 1,800만원, 세액공제 한도 합산 900만원, 연금저축 몫 600만원, 연금저축 가입자 1인당 실제 평균 161만원](../../../assets/learn/pension-account-limits/limits.svg)

<mark>한도가 막혀서 못 넣는 사람보다, 한도 근처에도 가지 않는 사람이 훨씬 많다</mark>는 뜻입니다. 이 글을 "한도 푸는 법"으로 찾아오셨다면 먼저 볼 것은 대개 600만원과 900만원 쪽이에요.
...
▶ **① ISA 만기자금 전환** — ISA(Individual Savings Account, 개인종합자산관리계좌)를 만기 해지하고 그 자금을 연금계좌로 옮기면, 옮긴 금액은 1,800만원 한도와 **별도로** 들어갑니다. 금액 상한도 없어요. 게다가 전환금액의 **10%,** 최대 300만원까지 그해 세액공제 한도에 얹어 줍니다. 900만원에 300만원이 더해져 <mark>한 해 최대 1,200만원</mark>까지 공제받는 구조죠. 단, ISA 만기 후 **60일 이내에** 납입해야 하고 추가 공제는 납입한 그해에만 적용됩니다.

▶ **② 퇴직금(이연퇴직소득)** — 퇴사하면서 받은 퇴직급여를 IRP로 받는 금액은 납입한도와 무관합니다. 애초에 세액공제 대상이 아니고(이미 퇴직소득세 체계 안에 있어요), 한도 계산에도 넣지 않습니다.

▶ **③ 주택차액(다운사이징)** — 60세 이상 1주택 고령가구가 살던 집을 팔고 더 싼 집으로 옮기면, 그 차액을 <mark>누적 1억원 한도로</mark> 연금계좌에 추가 납입할 수 있습니다. 요건이 촘촘해요 — 양도일 현재 거주자 또는 배우자가 60세 이상, 부부합산 1주택(6개월 이내 일시적 2주택 포함), 판 집의 기준시가 12억원 이하, 새로 산 집의 취득가액이 판 집의 양도가액보다 낮을 것, 양도일부터 6개월 이내 납입.
...
재정경제부는 **2026년 8월 3일** 「2026년 세제개편안」을 발표했습니다. 연금계좌와 관련해서는 <mark>15~34세 청년이 퇴직연금계좌에 납입한 금액에는 소득 수준과 관계없이 세액공제율 15%</mark>(지방소득세 포함 16.5%)를 적용하는 안이 담겼어요. 군 복무 기간은 나이 계산에서 빼 주므로 최대 40세까지 적용될 수 있고, 연금저축과 합쳐 연 900만원 한도라는 뼈대는 그대로입니다. 적용 시점은 **2027년 1월 1일 이후 납입분부터입니다.**
...
▶ **IRP는** 원칙적으로 법에 정한 사유가 있을 때만 중도인출할 수 있습니다. 「근로자퇴직급여 보장법 시행령」 제14조가 정한 사유는 무주택자의 본인 명의 주택 구입, 무주택자의 주거 목적 전세금·임차보증금 부담, 본인·배우자·부양가족의 6개월 이상 요양, 최근 5년 이내 파산선고 또는 개인회생절차 개시 결정, 천재지변 등이에요. 사유가 없으면 계좌를 통째로 해지하는 길밖에 없습니다.

&nbsp;

【⚠️ 목록이 두 개다 — 인출을 허락하는 법과 세금을 깎아주는 법이 다르다】

여기가 오늘 글에서 가장 오해가 잦은 지점입니다. **인출을 허용하는 법과 세율을 낮춰 주는 법이 서로 다른 법이고, 사유 목록도 다릅니다.**

| | 인출을 허용하는 규정 | 세율을 낮춰 주는 규정 |
| :--- | :--- | :--- |
| 근거 | 「근로자퇴직급여 보장법 시행령」 제14조 | 「소득세법 시행령」 제20조의2 |
| 부르는 이름 | 중도인출 사유 | **부득이한 사유** |
| 포함되는 것 | 무주택자 주택구입, 전세금·임차보증금, 6개월 이상 요양, 파산·개인회생, 천재지변 | 천재지변, 가입자의 사망·해외이주, 가입자·부양가족의 3개월 이상 요양, 가입자의 파산선고·개인회생절차 개시, 금융회사 영업정지 등 |
...
국가데이터처가 **2025년 12월 15일** 발표한 「2024년 퇴직연금통계」를 보면, 2024년 한 해 퇴직연금을 중도인출한 사람은 6만 7,000명, 금액은 3조원입니다. 사유는 이렇게 갈려요.
...
연금수령연차가 11년 이상이면 한도가 사라집니다. 한도를 넘겨 빼면 초과분은 연금이 아닌 것으로 보아 <mark>한도까지는 연금소득, 넘는 부분은 연금외수령</mark>으로 나눠 과세해요.
...
퇴직급여를 재원으로 하는 부분은 셈이 다릅니다. 이연퇴직소득세의 70%만 내고(수령기간 10년 초과 20년 이하는 60%, 20년 초과는 50%), 나머지는 감면돼요. <mark>오래 나눠 받을수록 감면 폭이 커지는</mark> 구조입니다.
...
▶ 한도를 늘리는 방법은 없지만 **1,800만원에 포함되지 않는 돈**은 있어요 — ISA 만기 전환금액(추가 공제 최대 300만원), 퇴직금, 60세 이상 1주택자의 주택차액(누적 1억원).
...
▶ ⚠️ **인출을 허락하는 사유와 세금을 깎아주는 사유는 다른 법의 다른 목록입니다.** 주택구입·전세보증금은 IRP 중도인출이 허용되지만 세율 감면은 없어요.
...
| 항목 | 내용 | 출처·기준일 |
| :--- | :--- | :--- |
| 납입한도 1,800만원과 제외 항목 | "연간 1천800만원", ISA 전환금액·주택차액·부동산 양도차액(누적 1억원 한도)은 별도 | 「소득세법 시행령」 제40조의2 제2항 제1호 가목 및 각 목, 국가법령정보센터 조문 원문, 2026-09-12 확인 |
| 세액공제 한도·공제율 | 연금저축 600만원, 퇴직연금 합산 900만원, 본세 15%·12% | 「소득세법」 제59조의3 제1항 조문 원문, 2026-09-12 확인. 지방소득세 10% 가산 시 16.5%·13.2%, 환급액 1,485,000원·1,188,000원은 **직접 계산** |
| ISA 전환 추가공제·고령가구 추가납입 | 전환금액의 10%·300만원 한도, 납입한 해에만 적용 / 1주택 고령가구 IRP 추가납입 1억원 한도 | 국세청 「연금계좌 세액공제」 안내, 2026-09-12 확인 |
| ISA 전환 60일 요건·한도 별도 | 만기 후 60일 이내 납입, 연 1,800만원 한도에 포함되지 않음 | 미래에셋증권 「ISA 만기자금 연금전환」 안내 및 증권사·금융 매체 **교차확인**, 2026-09-12 |
| 주택 다운사이징 요건 | 60세 이상, 부부합산 1주택(일시적 2주택 6개월 포함), 기준시가 12억원 이하, 축소주택 취득가액이 양도가액 미만, 양도일부터 6개월 이내 납입 | 「소득세법 시행령」 제40조의2 및 언론 보도·세무 해설 **교차확인**, 2026-09-12. ⚠️ 각 호 조문 원문을 항목별로 전부 대조하지는 못함 |
| 연금저축 현황 | 2025년 말 적립금 198조 2,000억원, 가입자 840만 3,000명, 연간 납입액 13조 5,000억원 | 금융위원회·금융감독원 발표(2026-06-18)를 보도한 파이낸셜뉴스·조세금융신문 **교차확인**, 2026-09-12. 1인당 약 161만원은 **직접 계산**(IRP 제외, 연금저축만) |
| 2026년 세제개편안 청년 공제 | 15~34세, 소득 무관 15%, 군 복무기간 제외로 최대 40세, 합산 900만원 한도, 2027-01-01 이후 납입분 | 재정경제부 「2026년 세제개편안」(2026-08-03 발표)을 정리한 KB·토스뱅크·조세금융신문 **교차확인**, 2026-09-12. ⚠️ 보도자료 원문 첨부파일을 직접 열어 대조하지 못함. **국회 심의 전 정부안** |
| 납입연도 전환특례 | 이전 과세기간 미공제액을 해당 과세기간 납입액으로 전환 신청, 홈택스 확인서 발급 후 금융회사 신청 | 「소득세법 시행령」 제118조의3 및 KB 「연금계좌 초과 납입금액 세액공제 받기」 **교차확인**, 2026-09-12 |
| 인출 순서 | 과세제외금액 → 이연퇴직소득 → 세액공제받은 납입액과 운용수익 | 「소득세법 시행령」 제40조의3 및 국세청 「연금소득의 범위」, 2026-09-12 확인 |
| IRP 중도인출 법정 사유 | 무주택자 주택구입, 전세금·임차보증금, 6개월 이상 요양, 5년 이내 파산·개인회생, 천재지변 등 | 「근로자퇴직급여 보장법 시행령」 제14조 및 KB·미래에셋증권 안내 **교차확인**, 2026-09-12 |
| 소득세법상 부득이한 사유 | 천재지변, 사망·해외이주, 3개월 이상 요양, 파산·개인회생, 금융회사 영업정지 등 / 확인일부터 6개월 이내 서류 제출 | 「소득세법 시행령」 제20조의2 및 국세청 연금소득 안내·증권사 상품설명서 **교차확인**, 2026-09-12. ⚠️ 조문 각 호 원문을 직접 대조하지는 못함 |
...
| 2024년 중도인출 통계 | 6만 7,000명·3조원, 주택구입 3만 8,000명(56.5%)·1조 8,000억원, 주거임차 1만 7,000명(25.5%), 회생절차 8,727명(13.1%) | 국가데이터처 「2024년 퇴직연금통계」(2025-12-15 발표)를 보도한 전자신문·서울경제·한국일보 **교차확인**, 2026-09-12. 그래프의 '그 밖 4.9%'와 '82.0%'는 **직접 계산** |
| 연금수령 요건·한도 공식 | 55세 이후 개시 신청, 가입일부터 5년 경과(이연퇴직소득 있으면 제외), 한도 = 평가액 ÷ (11 − 연금수령연차) × 120% | 「소득세법 시행령」 제40조의2 제3항 및 국세청 「연금소득의 범위」, 2026-09-12 확인 |
| 연금소득 원천징수세율 | 70세 미만 5%, 70~79세 4%, 80세 이상 3%, 종신형 3%, 이연퇴직소득은 이연퇴직소득세의 70%·60%·50% | 국세청 「연금소득 원천징수 방법」, 2026-09-12 확인. 본문의 5.5%·4.4%·3.3%는 지방소득세 포함. ⚠️ 국세청은 종신형을 3%로 적으나 금융회사 안내는 55~69세 종신형에 4%를 적용한다고 설명하는 경우가 많아, 계약 형태별로 금융회사 확인 필요 |
| 연 1,500만원 초과 과세 | 종합과세 또는 16.5% 분리과세 선택, 공적연금·부득이한 사유 인출액·이연퇴직소득 제외 | 국세청 연금소득 안내 및 「절세 계좌 3종」 편과 같은 근거, 2026-09-12 확인 |

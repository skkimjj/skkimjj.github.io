...
저는 투자를 시작하고 한동안 증권사 리포트를 이렇게 읽었습니다. 맨 윗줄의 **목표주가**만 보고, 현재주가보다 높으면 "오른다는 뜻이구나" 하고 창을 닫았습니다. 목표주가 120,000원에 현재주가 91,300원이면 <mark>30% 남았다고 계산했습니다.</mark>
...
| **실적 추정표** | 매출·영업이익·EPS 등 향후 전망 | **(E)·(F) 표기** — 확정치가 아니라 추정치 |
| **투자등급 비율·괴리율** | 그 증권사의 등급 분포와 목표주가 적중 이력 | 규정상 **의무 표시 항목** |

투자의견 옆에는 **'유지'(Maintain)나 '상향·하향'(Upgrade·Downgrade)** 꼬리표가 붙습니다. 저는 이 꼬리표가 등급 자체보다 정보량이 많다고 봅니다. 반년 전에도 매수였던 종목의 '매수 유지'와, 어제까지 중립이었다가 오늘 매수로 올라간 것은 <mark>전혀 다른 사건이니까요.</mark>

참고로 리포트를 쓰는 사람은 아무나가 아닙니다. 조사분석자료를 작성하거나 심사·승인하는 인력은 **금융투자분석사로** 금융투자협회에 등록돼 있어야 합니다. 우리가 '애널리스트'라 부르는 직함의 제도적 이름입니다.
...
▶ 그래서 리포트를 볼 때 <mark>맨 뒷장의 '투자등급 관련 사항' 고지를 한 번은 읽어야 합니다.</mark> 등급 정의가 거기 적혀 있고, 다른 회사의 '매수'와 그대로 비교하면 안 됩니다.
...
![매도 의견 비율 — 국내 최고치 1.3%, 제이피모간 12.1%, 모간스탠리 15.4%, 메릴린치 21.9%](../../../assets/learn/reading-analyst-reports/sell-rating-ratio.svg)
...
<mark>기대는 34%, 결과는 4%였습니다.</mark> 예측오차 절댓값 45%는 목표주가와 실제 주가가 평균적으로 그만큼 벌어졌다는 뜻입니다.
...
| 의무 항목 | 내용 | 근거 |
| :--- | :--- | :--- |
| **투자등급 비율** | 기준일로부터 **과거 1년간** 공표한 최근일 투자등급의 비율을 **3단계로 구분** 표시, 3개월마다 갱신 | 제2-33조 제5항 |
| **목표주가 괴리율** | **목표가격과 실제 주가(종가)의 변동추이 그래프** + 괴리율(목표가격 대비 차이의 백분율) 표시 | 제2-33조 제3항 |
...
<mark>**(E)** 또는 **(F)** 표기가 붙은 열이 추정치입니다</mark>(Estimate·Forecast). 확정 실적과 추정치가 같은 표에 나란히 있어서, 표기를 놓치면 아직 벌지 않은 이익을 확정 숫자로 읽게 됩니다.
...
| 경로 | 볼 수 있는 것 | 특징 |
| :--- | :--- | :--- |
| **한경 컨센서스** | 기업·산업·시장·경제·파생 리포트 원문(PDF) | 투자의견·목표주가 상향·하향으로 **필터링** 가능 |
...
▶ 목표주가는 실적 추정 × 배수의 결과 — 예상수익률 평균 33.91%, 실현수익률 평균 **4.07%**
...
| 매수 의견 비중·수익률 통계 | 2000년대 67.3% / 2010년대 89.6% / 2020~2024년 93.1%, 예상수익률 33.91%(2015~2024년)·실현수익률 4.07%(2015~2023년)·예측오차 절댓값 45.22%, 표본 735,162건·애널리스트 2,601명·증권사 43곳·기업 2,713곳, 발간기업 비중 30%·상위 200개 집중도 69% | 자본시장연구원 연구보고서 26-06 「애널리스트의 낙관성, 정확성, 정보성」(김준석 선임연구위원, 2026-05-04) |
| 시장별 커버리지 | 코스피 44%·코스닥 23%, 상위 100개 45% | 위 보고서를 다룬 언론 보도(2026-05-04) |
| 매도 의견 비율 | 2025-12-31 기준 국내 31곳 중 28곳 0.0%, 신영증권 1.3%·DS투자증권 0.6%·메리츠증권 0.6%, 매수 100.0% 4곳, 외국계 메릴린치 21.9%·골드만삭스 16.3%·모간스탠리 15.4%·제이피모간 12.1% | 금융투자협회 전자공시서비스 '증권사별 리포트 투자등급 비율'을 집계한 보도(2026-03-18). 리포트 미발행 1곳 제외 |
...
| 등급기준 예시 | 교보증권(코스피 대비, 6개월, 매수 10% 이상/Trading Buy/보유 -10~10%/매도 -10% 이하), 한화투자증권(절대수익률, 12개월, BUY +10% 이상/HOLD -10~+10%/SELL -10% 이하) | 각 사 공시 등급기준(2026년 8월 확인). 한화투자증권 변경 시행일은 공지에 없어 본문에 넣지 않음 |
| 무료 열람 경로 | 한경 컨센서스(전체·기업·산업·시장·경제·파생, 투자의견·목표주가 필터), 네이버 증권 리서치(6종), 금융투자협회 전자공시(투자등급 비율), DART | 각 서비스 2026-08-20 접속 확인 |

...
그리고 이 구간을 실제로 유도하는 세부 금리는 성명문이 아니라 **Implementation Note**라는 별도 문서에 적힙니다. 7월 29일 자 문서에서 지급준비금 부리금리(IORB)는 <mark>연 3.65%로 유지</mark>됐습니다(7월 30일 적용).
...
그런데 SEP 표에 실린 **2026년 말 중간값은 3.8%입니다.** 현재 목표범위 중간(3.625%)보다 높으니 중간값만 보면 "올해 한 번쯤 올릴 생각"으로 읽힙니다. 실제로는 <mark>가장 많은 8명이 '현 수준 유지'를 찍었고, 3.8%에 점을 찍은 사람은 아무도 없습니다.</mark> 9번째와 10번째 점의 중간이라는 계산 결과일 뿐이죠.
...
- **점도표 중간값은 통계입니다.** 2026년 6월 중간값 3.8%였지만 실제로는 <mark>9대 9로 갈렸고 8명이 '현 수준 유지'</mark>였습니다.
...
| 부리금리(IORB) | 연 3.65% 유지(7월 30일 적용) | Implementation Note, 2026년 7월 29일 |

...
다음 편에서는 [**ETF 투자설명서 읽는 법**](/learn/reading-etf-prospectus/)을 다룹니다. 상품 페이지와 투자설명서에서 기초지수와 추적 방법, PDF(Portfolio Deposit File, 납입자산구성내역), 총보수와 실부담비용, 괴리율·추적오차 공시, 분배금 지급기준일을 어디서 어떻게 확인하는지 실제 화면 기준으로 정리하겠습니다.

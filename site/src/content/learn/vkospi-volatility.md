...
<figure class="chart">
  ...
  <small>세로축 = VKOSPI 종가 · 가로축은 날짜 간격에 비례 · 점선 = 40(언론이 '공포 구간'의 경계로 쓰는 값) · 1월 2일·6월 1일·6월 29일 값은 언론 보도, 7월 이후는 한국거래소 Open API 일별 종가 · 6월 29일은 한국거래소 공식 발표(2009년 4월 13일) 이후 최고 종가</small>
</figure>
...
이 사이트의 개장 전 브리핑도 실제로 이 문제를 겪었습니다. 2026년 7월 14일부터 8월 20일까지 26거래일 동안 VKOSPI는 **하루도 빠짐없이 55를 넘었고**(최저 55.28, 평균 75.3), 그 사이 6월 고점 96.94에서 50대 후반으로 40% 넘게 내려온 완화 흐름이 '공포 구간'이라는 한 단어에 가려졌습니다. <mark>매일 같은 답을 내는 기준으로는 완화와 악화를 구분할 수 없습니다.</mark>
...
'경보 구간'이라는 한 단어보다 <mark>고점에서 절반 넘게 내려왔지만 여전히 평시의 1.7배라는 두 사실</mark>이 함께 전달됩니다. 이 네 단계 구분과 경계값(25·40·60)은 **이 사이트의 브리핑이 정한 것**이고 거래소나 업계의 공식 기준이 아니라는 점도 밝혀 둡니다.
...
다음 편에서는 [**주식 매매 수수료와 세금**](/learn/trading-costs/)을 다룹니다. 100만원어치를 사고팔 때 위탁수수료·유관기관 제비용·증권거래세·농어촌특별세로 부과되는 비용을 항목별로 계산하고, 시장별 세율과 최근 세율 변경 이력을 표로 정리합니다.
